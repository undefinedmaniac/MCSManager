/****************************************************************************
** Meta object code from reading C++ file 'imcscpservertable.h'
**
...
#include "../../MCSManager_V1/mcsmanager/mcserver/addons/mcscp/interfaces/imcscpservertable.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'imcscpservertable.h' doesn't include <QObject>."
...
void Mcscp::IMcscpServerTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->KeyUpdate((*reinterpret_cast< IMcscpServerTable::Key(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (IMcscpServerTable::*_t)(IMcscpServerTable::Key );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IMcscpServerTable::KeyUpdate)) {
                *result = 0;
                return;
            }
        }
