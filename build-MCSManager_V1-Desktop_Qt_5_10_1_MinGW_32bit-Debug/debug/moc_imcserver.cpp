/****************************************************************************
** Meta object code from reading C++ file 'imcserver.h'
**
...
#include "../../MCSManager_V1/mcsmanager/mcserver/server/interfaces/imcserver.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'imcserver.h' doesn't include <QObject>."
...
void Server::IMcServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (IMcServer::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IMcServer::started)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (IMcServer::*_t)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IMcServer::stopped)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (IMcServer::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IMcServer::error)) {
                *result = 2;
                return;
            }
        }
